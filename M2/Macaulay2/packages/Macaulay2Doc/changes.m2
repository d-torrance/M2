...
document {
     ...
     UL {
	  LI { "packages that have been published and certified:",
		   ...
		   LI { star, " ", TO "FastMinors::FastMinors", ", a package by Marcus Robinson, Karl Schwede, Yuhui (Wei) Yao, and Yuhui (Wei) Yao for faster linear algebra operations, has been published." },
		   LI { star, " ", TO "MixedMultiplicity::MixedMultiplicity", ", a package by Vivek Mukundan, Sudeshna Roy, J. K. Verma, and J. K. Verma for Mixed Multiplicities of ideals, has been published." },
		   LI { star, " ", TO "RandomPoints::RandomPoints", ", a package by Zhan Jiang, Sarasij Maitra, Thai Nguyen, Frank-Olaf Schreyer, Karl Schwede, and Karl Schwede for find a point in a given variety over a finite field, has been published." },
		   LI { star, " ", TO "SimplicialComplexes::SimplicialComplexes", ", a package by Ben Hersey, Alexandre Zotine, and Alexandre Zotine for exploring abstract simplicial complexes within commutative algebra, has been published." }
		   }
	       },
	  LI { "new packages:",
	       UL {
