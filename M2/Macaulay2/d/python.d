...
import ObjectGetIter(o:pythonObject):pythonObjectOrNull;
PyObjectGetIter(e:Expr):Expr :=
    when e
    is x:pythonObjectCell do toExpr(ObjectGetIter(x.v))
    else WrongArgPythonObject();
setupfun("pythonObjectGetIter",PyObjectGetIter);
