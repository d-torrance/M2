...
-- false if we return after an abort
firstTime := class path === Symbol
if not firstTime then interpreter()
...
(loadDepth = 3; processCommandLineOptions 4; interpreter())
