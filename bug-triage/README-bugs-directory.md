...
> **This project is complete**, and this file is its record. All 857 rows in `catalog.tsv`
> and all 191 rows in `asks.tsv` carry a verdict: 414 `fixed`, 142 `wontfix`, 131 `open`,
> 82 `obsolete`, 77 `duplicate`, 11 `stale-repro`. 139 issues were filed under the
> [`bugs directory`](https://github.com/Macaulay2/M2/labels/bugs%20directory) label and
> [#36](https://github.com/Macaulay2/M2/issues/36) was answered. Nothing below is being
