...
Macaulay2 has two ways of giving a function optional arguments, and they differ: a plain function
takes them through `>>`, while a method function declares them with `method(Options => ...)`. The
documentation node "making new functions with optional arguments" explains the first. This two-line
file asks that it link to `method`, which explains the second.
